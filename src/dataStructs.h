...
enum Verbose {VERBOSE_NONE, VERBOSE_STATS, VERBOSE_JOBS, VERBOSE_BRIEF, VERBOSE_ALL, END_VERBOSE};
...
enum RegularGETSFieldID {RDF_Server_TypeName, RDF_Server_ID, RDF_Server_hourlyRate, RDF_Server_State, 
